...
public class SQLParser extends Parser {
	...
	public static final int
		...
		ASC=25, DESC=26, IDENT=27, QUOTED_IDENT=28, USER_VAR=29, TRUE=30, FALSE=31, 
		HEX_INT=32, BINARY_INT=33, INT=34, FLOAT=35, STRING=36, HEX_STRING=37, 
		BIT_STRING=38, EQ=39, NE=40, LT=41, LE=42, GT=43, GE=44, LIKE=45, IN=46, 
		IS=47, NULL=48, PLUS=49, MINUS=50, STAR=51, DIV=52, MOD=53, AND_OP=54, 
		OR_OP=55, NOT_OP=56, COMMA=57, DOT=58, SEMICOLON=59, LPAREN=60, RPAREN=61, 
		LINE_COMMENT=62, BLOCK_COMMENT=63, WS=64, LINE_CONTINUATION=65, ERROR_CHAR=66;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DESC", "IDENT", "QUOTED_IDENT", "USER_VAR", "TRUE", "FALSE", "HEX_INT", 
			"BINARY_INT", "INT", "FLOAT", "STRING", "HEX_STRING", "BIT_STRING", "EQ", 
			"NE", "LT", "LE", "GT", "GE", "LIKE", "IN", "IS", "NULL", "PLUS", "MINUS", 
			"STAR", "DIV", "MOD", "AND_OP", "OR_OP", "NOT_OP", "COMMA", "DOT", "SEMICOLON", 
			"LPAREN", "RPAREN", "LINE_COMMENT", "BLOCK_COMMENT", "WS", "LINE_CONTINUATION", 
			"ERROR_CHAR"
		};
	}
	...
	public static class ComparisonExpressionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SQLParserVisitor ) return ((SQLParserVisitor<? extends T>)visitor).visitComparisonExpression(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(198);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 282024195653632L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
